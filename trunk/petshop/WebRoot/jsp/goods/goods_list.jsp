							...
							<table>
								<tbody>
									<tr>
										<td>
											<html:img
												src="<%=request.getContextPath()%>/resource/${goods.g_id}.jpg"
												alt="${goods.g_id}.jpg" />
										</td>
									</tr>
									<tr>
										<td>
											<bean:write name="goods" property="g_name" />
										</td>
									</tr>
									<tr>
										<td>
											<bean:write name="goods" property="g_price" />
										</td>
									</tr>
									<tr>
										<td>
											<html:button property="" value=" 添加到购物车" />
										</td>
									</tr>
								</tbody>
							</table>
