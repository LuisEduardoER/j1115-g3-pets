...
<table>
	<tbody>
		<tr>
			<td width="10px">
				<img src="<%=request.getContextPath()%>/resource/${goods.gid}.jpg"
					alt="${goods.gid}.jpg" />
			</td>
			<td>
				<table>
					<tbody>
						<tr>
							<td>
								<bean:write name="goods" property="gname" />
							</td>
						</tr>
						<tr>
							<td>
								一口价：
								<bean:write name="goods" property="gprice" />
							</td>
						</tr>
						<tr>
							<td>
								...
								库存
								<bean:write name="goods" property="gnum" />
								个（已售出
