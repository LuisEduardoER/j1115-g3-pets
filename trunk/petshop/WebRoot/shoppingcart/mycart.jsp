		...
		%>
				<tr id="tr${og.goodsid}">
					...
					<td width="250px">
						...
						<span id="msg${og.goodsid}" style="color:red; font-size:12px;"><logic:present name="goodsmsg${og.goodsid}">商品库存不足</logic:present></span>
					</td>
...
<script language="javascript" type="text/javascript">
	...
	function createRequest() {//创建一个request
 	...
 	function modify(arg){
 		createRequest();
 		marg = arg;
 		if((document.getElementById(arg).value).match(/^[0-9]+$/) == null){
 			document.getElementById('msg'+arg).innerHTML = "请输入整数";
