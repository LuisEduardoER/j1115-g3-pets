...
<table width="100%" border="0" align="center" cellPadding="0" cellSpacing="0">
  <tr height="25">
    <td style="border-bottom: #2FA1DB 1px solid;padding-left:5px;"><img src='images/newitem.gif' width='7' height='10' alt=''/></td>
    <td style="border-bottom: #2FA1DB 1px solid"><A href="orderlist.php" target="right">订单ING</A></td>
  </tr>
  <tr height="25">
    <td style="border-bottom: #2FA1DB 1px solid;padding-left:5px;"><img src='images/newitem.gif' width='7' height='10' alt=''/></td>
    <td style="border-bottom: #2FA1DB 1px solid"><A href="checkorder.php" target="right">历史订单</A></td>
  </tr>
</table>
</div>
<!-- Item 0 End -->
...
<table width="100%" border="0" align="center" cellPadding="0" cellSpacing="0">
  <tr height="25">
    <td style="border-bottom: #2FA1DB 1px solid;padding-left:5px;"><img src='images/newitem.gif' width='7' height='10' alt=''/></td>
    <td style="border-bottom: #2FA1DB 1px solid"><A href="" target='_blank'>网银充值</A></td>
  </tr>
</table>
</div>
</div>
