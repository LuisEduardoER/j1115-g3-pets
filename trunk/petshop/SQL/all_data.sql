...
prompt Created on 2011年8月4日星期四 by Administrator
set feedback off
set define off
prompt Creating P_CATEGORY...
...
(
  ...
  G_SCORE NUMBER(2,1) default 0,
  G_SOLD  NUMBER default 0 not null
)
tablespace USERS
  pctfree 10
  initrans 1
...
alter table P_GOODS
  ...
  references P_CATEGORY (C_ID) on delete cascade;
alter table P_GOODS
  add check (g_score between 0 and 5);

prompt Creating P_USERS...
...
alter table P_CART
  ...
  references P_USERS (U_ID) on delete cascade;
alter table P_CART
  add foreign key (G_ID)
  references P_GOODS (G_ID) on delete cascade;

prompt Creating P_ORDERS...
...
(
  ...
  O_STATE    NUMBER(1) default 0 not null,
  O_TYPE     NUMBER(1),
  O_SUM      NUMBER
)
tablespace USERS
...
alter table P_ORDERS
  ...
  references P_USERS (U_ID) on delete cascade;
alter table P_ORDERS
  add check (o_state between 0 and 5);

prompt Creating P_ORDERS_INFO...
...
alter table P_ORDERS_INFO
  add foreign key (O_ID)
  references P_ORDERS (O_ID) on delete cascade;
alter table P_ORDERS_INFO
  add foreign key (G_ID)
  references P_GOODS (G_ID) on delete cascade;
...
values (10002, 'user5', '111', 1, 500);
insert into P_USERS (U_ID, U_NAME, U_PASS, U_IDENTITY, U_MONEY)
values (10003, 'user8', '111', 1, 500);
insert into P_USERS (U_ID, U_NAME, U_PASS, U_IDENTITY, U_MONEY)
values (1, 'Administrator', '123456', 0, 0);
insert into P_USERS (U_ID, U_NAME, U_PASS, U_IDENTITY, U_MONEY)
values (2, 'user1', '1212', 1, 325);
insert into P_USERS (U_ID, U_NAME, U_PASS, U_IDENTITY, U_MONEY)
values (3, 'user2', '123456', 1, 500);
insert into P_USERS (U_ID, U_NAME, U_PASS, U_IDENTITY, U_MONEY)
values (10001, 'user3', '111', 1, 500);
commit;
...
values (64, 2, to_date('04-08-2011 10:56:01', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 1, null, 34);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (62, 2, to_date('04-08-2011 10:42:01', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 1, null, 45675);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (63, 2, to_date('04-08-2011 10:47:51', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 1, null, 67);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (65, 2, to_date('04-08-2011 14:13:49', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 4, null, null);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (66, 2, to_date('04-08-2011 14:23:51', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 3, null, null);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (69, 2, to_date('04-08-2011 14:39:09', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 0, null, null);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (68, 2, to_date('04-08-2011 14:32:28', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 1, null, null);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (70, 2, to_date('04-08-2011 14:43:04', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 1, null, 75);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (72, 2, to_date('04-08-2011 15:42:34', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 1, null, 75);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (73, 2, to_date('04-08-2011 16:18:26', 'dd-mm-yyyy hh24:mi:ss'), 'sss', '杭州', 151, 3, 1, 100);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (42, 2, to_date('03-08-2011 15:35:24', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 4, null, 7);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (43, 2, to_date('03-08-2011 15:46:53', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 4, null, 67);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (44, 2, to_date('03-08-2011 16:23:22', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 4, null, 3454);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (45, 2, to_date('03-08-2011 16:25:23', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 4, null, 567);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (46, 2, to_date('03-08-2011 16:26:59', 'dd-mm-yyyy hh24:mi:ss'), 'xuguifeng', '计量', 15158109559, 4, null, 67);
insert into P_ORDERS (O_ID, U_ID, O_TIME, O_RECEIVER, O_ADDRESS, O_PHONE, O_STATE, O_TYPE, O_SUM)
values (1, 2, to_date('02-08-2011 15:31:59', 'dd-mm-yyyy hh24:mi:ss'), 'sdsd', 'sdsdfsdf', 13213213, 1, 2, 67);
commit;
